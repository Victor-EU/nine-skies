...
- [ ] Give Expedition 1 a fifth waypoint if it is to arrive *at* Lhasa rather than 1,949 m over it — the plateau drops 1,350 m in the last 100 km and the final leg is flown at cruise, so no policy can descend into the city (F20). A route change; the slow-the-whole-leg version costs sixteen minutes
