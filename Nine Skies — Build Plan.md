...
- [ ] Decide whether Expedition 1 keeps its climb or its twenty-five minutes — one line of `content/expeditions/sea-to-sky.yaml` (F18). A writing call; G2 measures whichever it is
