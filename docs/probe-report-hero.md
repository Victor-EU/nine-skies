...
2026-09-24 · 7 of 7 sited areas built, 1 unsited · bias 0.4 · generated by `python -m nineskies.probe --area all`.
...
| --- | --- | ---: | ---: | ---: | --- |
| 1 → 2 | this grid, 90 m | 1,816 m → 1,736 m | 1,816 m | 0 m | 26.8837 N, 99.9863 E, 2.6 km from `shigu` |
...
| Guilin, Elephant Trunk Hill | city | — | — | — | outside this build |
| Yangshuo | city | — | — | — | outside this build |
| The Taklamakan's central dunes | valley | — | — | — | outside this build |
| Huangshan, Lotus Peak | summit | — | — | — | outside this build |
| Changbai Mountain, Heaven Lake | lake | — | — | — | outside this build |
...
`everest` · 9 tiles of 129 x 129 at 90 m · hero tiles 146,113–149,116 · holds everest

The second probe deferred to this grid: at 1 km the summit is unpassable at any tolerance because grid phase alone swings it 153 m (F12).
...
| Shigu, the first bend of the Yangtze | valley | — | — | — | outside this build |
| Lhasa | city | — | — | — | outside this build |
| Everest summit | summit | 8,712 m | 6,489 m | 2,224 m | 4,368 m |
| Ayding Lake, Turpan | lake | — | — | — | outside this build |
| The Tarim's terminal basin | valley | — | — | — | outside this build |
| Guilin, Elephant Trunk Hill | city | — | — | — | outside this build |
| Yangshuo | city | — | — | — | outside this build |
...
`taklamakan` · 16 tiles of 129 x 129 at 90 m · hero tiles 138,221–142,225 · holds taklamakan-dunes

Design v2, scene 7: dunes 100-300 m high and 1-3 km crest to crest alias into noise on a 1 km grid; at 90 m they are dunes.
...
| Guilin, Elephant Trunk Hill | city | — | — | — | outside this build |
| Yangshuo | city | — | — | — | outside this build |
| The Taklamakan's central dunes | valley | 1,125 m | 1,120 m | 5 m | 87 m |
| Huangshan, Lotus Peak | summit | — | — | — | outside this build |
| Changbai Mountain, Heaven Lake | lake | — | — | — | outside this build |
| Qinghai Lake | lake | — | — | — | outside this build |
| Heihe, Heilongjiang | city | — | — | — | outside this build |
...
`guilin` · 180 tiles of 129 x 129 at 30 m · hero tiles 1037,210–1047,228 · holds guilin, yangshuo

Design v2, scene 3: the towers are 100-500 m across, which 90 m draws as blobs; this is the one area cut at the source's own 30 m.
...
| Ayding Lake, Turpan | lake | — | — | — | outside this build |
| The Tarim's terminal basin | valley | — | — | — | outside this build |
| Guilin, Elephant Trunk Hill | city | 157 m | 144 m | 13 m | 771 m |
| Yangshuo | city | 119 m | 102 m | 17 m | 457 m |
| The Taklamakan's central dunes | valley | — | — | — | outside this build |
| Huangshan, Lotus Peak | summit | — | — | — | outside this build |
| Changbai Mountain, Heaven Lake | lake | — | — | — | outside this build |
| Qinghai Lake | lake | — | — | — | outside this build |
...
**Above it** is the column F50 added, and it is the one that would have caught F50: relief cannot separate a gorge floor from the cliff over it, because both sit in the same 20 km box and both report ~3,800 m. A place marked `on_channel` in `places.py` promises to be on the water and is held to 109 m of it on this grid's 30 m cells — the waypoint this probe used to carry stood **1,260 m** above the Jinsha and passed every check there was. The tolerance scales with the cell because the floor of this measurement does: a river falls (46 m through this gorge at the source's 30 m, 1 m at Shigu where the same river runs flat) and a cell wider than the water is mostly not water (63 m at 90 m, 186 m at 1 km, on ground that has not moved). A column that read zero on a steep river would be measuring something else.
...
`huangshan` · 30 tiles of 129 x 129 at 30 m · hero tiles 1223,382–1228,388 · holds huangshan

Design v2 as decided on 23 September 2026: the film opens on Huangshan in a sea of clouds. The massif's ridges read at 90 m; its spires are the picture, and they are 30 m features like the karst.
...
| Yangshuo | city | — | — | — | outside this build |
| The Taklamakan's central dunes | valley | — | — | — | outside this build |
| Huangshan, Lotus Peak | summit | 1,556 m | 877 m | 679 m | 1,656 m |
| Changbai Mountain, Heaven Lake | lake | — | — | — | outside this build |
| Qinghai Lake | lake | — | — | — | outside this build |
| Heihe, Heilongjiang | city | — | — | — | outside this build |
| Tengchong, Yunnan | city | — | — | — | outside this build |
...
`changbai` · 12 tiles of 129 x 129 at 90 m · hero tiles 460,255–464,258 · holds changbai-tianchi

Design v2 as decided on 23 September 2026: scene 6 crosses the grassland and ends circling the crater lake. The caldera is 5 km across, five samples on the country grid; at 90 m it is a crater.
...
| The Taklamakan's central dunes | valley | — | — | — | outside this build |
| Huangshan, Lotus Peak | summit | — | — | — | outside this build |
| Changbai Mountain, Heaven Lake | lake | 2,188 m | 2,188 m | 0 m | 1,368 m |
| Qinghai Lake | lake | — | — | — | outside this build |
| Heihe, Heilongjiang | city | — | — | — | outside this build |
| Tengchong, Yunnan | city | — | — | — | outside this build |
